...
### NPC
Non-player character, управляет персонажем, неподконтрольным игроку, в
соответствии с `Behaviour`.

### Behaviour
Задает поведение NPC
...
### LevelGenerator
Позволяет генерировать различные уровни.

### CustomLevelStorage
Позволяет загружать и сохранять уровни.
